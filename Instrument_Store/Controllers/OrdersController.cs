...
namespace Instrument_Store.Web.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,ProductOrdersId,StoreId,Date,Quantities,TotalPrice")] Orders orders)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,CustomerId,ProductOrdersId,StoreId,Date,Quantities,TotalPrice")] Orders orders)
        {
